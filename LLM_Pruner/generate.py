...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_model', type=str, default="/nfs/home/9303_xiechuanlong/dx/zhuyao/LLM-Prunerdx/zhuyao/model/Llama-2-13b-hf", help='base model name')
    parser.add_argument('--model_type', type=str, required=True, help = 'choose from ')
    parser.add_argument('--ckpt', type=str, default="/nfs/home/9303_xiechuanlong/dx/zhuyao/LLM-Pruner/prune_log/llama2_13b_prune0.2/pytorch_model.bin")
    parser.add_argument('--lora_ckpt', type=str, default="/nfs/home/9303_xiechuanlong/dx/zhuyao/LLM-Pruner/tune_log/llama2_13b_prune0.2/checkpoint-1400")

...
#         low_cpu_mem_usage=True if args.torch_version >=1.9 else False
    ...
    print(logger.best_checkpoint_path)
    model.half()
    torch.save({
        'model': model, 
        'tokenizer': tokenizer,
...
#     save_model = f"output_model/llama-2-7b-pruner{args.pruning_ratio}"
#     if not os.path.exists(save_model):
#         os.makedirs(save_model)
#     torch.save(model, f'{save_model}/pruned_model.pt')    
#     torch.save(model, f'{save_model}/pruned_model.bin')
